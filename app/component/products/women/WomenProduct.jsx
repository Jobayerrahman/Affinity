...
function WomenProduct(props) {
    ...
    return (
        <section className="lg:px-1 py-10">
                <TitleHeader title='Women Fashion'>
                    <div className="flex justify-between items-center bg-slate-100 p-1 rounded-lg gap-3">
                        ...
                        <button onClick={()=>setCategory('tops')} className={`py-2 px-4 cursor-pointer font-semibold text-slate-700 dark:text-slate-100  ${category ==='tops' ? 'bg-[#cbd5e1]' : 'bg-transparent'} rounded-md uppercase`}>Tops</button>
